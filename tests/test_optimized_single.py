...
def test_ic_model_single_thread():
    print("Testing Independent Cascade Model (Single Thread)...")
...
def test_lt_model_single_thread():
    print("Testing Linear Threshold Model (Single Thread)...")
...
def test_large_graph_single_thread():
    print("Testing with larger graph (Single Thread)...")
...
if __name__ == "__main__":
    print("=" * 60)
    print("PyNetIM C++ Optimization Tests (Single Thread)")
    print("=" * 60)
    print()
    
    test_graph_basic()
    test_ic_model_single_thread()
    test_lt_model_single_thread()
    test_large_graph_single_thread()
