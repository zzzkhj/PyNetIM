...
PYBIND11_MODULE(independent_cascade_model, m) {
    ...
    py::class_<pynetim::IndependentCascadeModel>(m, "IndependentCascadeModel")
        ...
        .def("run_single_simulation",
            [](const pynetim::IndependentCascadeModel& self, py::object seed_obj) {
        ...
        .def("run_monte_carlo_diffusion",
            [](const pynetim::IndependentCascadeModel& self, int rounds, py::object seed_obj, bool use_multithread = false, int num_threads = 0) {
                bool use_random_seed = seed_obj.is_none();
                unsigned int seed = use_random_seed ? 0 : py::cast<unsigned int>(seed_obj);
