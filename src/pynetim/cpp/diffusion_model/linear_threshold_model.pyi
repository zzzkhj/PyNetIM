...
class LinearThresholdModel:
    def __init__(self, graph: 'IMGraphCpp', seeds: Set[int], theta_l: float = 0.0, theta_h: float = 1.0, record_activated: bool = False, record_activation_frequency: bool = False) -> None: ...
